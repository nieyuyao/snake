...
export const GAME_OVER = 'event_game_over'; //蛇死亡之后通知分数变化以及通知食物管理器
export const GAME_RESTART = 'event_game_restart'; //蛇死亡之后通知分数变化以及通知食物管理器
...
export const SNAKE_VEC_MAX = 5; //蛇的最大速度
export const SNAKE_VEC_MIN = 3; //蛇的最小速度
export const SNAKE_VEC_0 = 3; //蛇的初始速度
